...
int main() {
    ...
    Sequential<TensorPtr> model( // Initialize model
        {make_shared<Dense>(3, 4, "relu", Initializers::he_uniform, "Dense0"),
         make_shared<Dense>(4, 3, "relu", Initializers::he_uniform, "Dense1"),
         make_shared<Dense>(3, 1, "linear", Initializers::he_uniform, "Dense2")},
